    ...
    return (
        <div className="space-y-8 p-4 text-foreground">
            <div className="flex justify-between items-center pb-6 border-b">
                <h1 className="text-4xl font-bold">فرق العمل</h1>
                <Button>
            ...
            {workspaces.length === 0 && (
                <div className="col-span-full py-12 text-center text-muted-foreground border-dashed border-2 rounded-lg">
                    <Users className="w-12 h-12 mx-auto mb-4 opacity-50" />
                    <p>لا توجد فرق عمل بعد. اضغط على أزر "إنشاء فريق جديد" للبدء.</p>
                </div>
            )}
        </div>
    </div >
