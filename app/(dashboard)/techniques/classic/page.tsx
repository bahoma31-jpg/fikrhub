  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-4 text-foreground">
      ...
      <div className="flex items-center gap-4 border-b pb-6">
        ...
        <div>
          <h1 className="text-4xl font-bold mb-2 text-foreground">العصف الذهني التقليدي</h1>
          <p className="text-lg text-muted-foreground">توليد أكبر قدر ممكن من الأفكار دون قيود</p>
        </div>
      </div>
