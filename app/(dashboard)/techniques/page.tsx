...
import { TechniquesGrid } from '@/components/techniques/techniques-grid';
...
export default function TechniquesPage() {
    return (
        <div className="space-y-8 p-4">
            {/* Header */}
            <div>
                <h1 className="text-4xl font-bold mb-4 text-foreground font-cairo">تقنيات العصف الذهني</h1>
            ...
            <div className="bg-muted p-6 rounded-lg text-foreground">
                <h3 className="font-bold text-lg mb-2 font-cairo">كيف تختار التقنية المناسبة؟</h3>
                <ul className="space-y-2 text-sm text-muted-foreground font-tajawal">
