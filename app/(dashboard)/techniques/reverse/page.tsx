  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-4 text-foreground">
      ...
      <div className="flex items-center gap-4 border-b pb-6">
        <div className="text-4xl bg-destructive/10 p-4 rounded-lg">{/* We don't have lucide emoji so using raw */}'🔄'</div>
        <div>
          <h1 className="text-4xl font-bold mb-2 text-foreground">العصف الذهني العكسي</h1>
          <p className="text-lg text-muted-foreground">حل المشكلة بطريقة عكسية</p>
        </div>
      </div>
