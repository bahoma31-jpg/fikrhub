...
export const metadata: Metadata = {
  title: 'الخرائط الذهنية | FikrHub',
  description: 'تمثيل بصري للمعلومات',
};
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-4 text-foreground">
      ...
      <div className="flex items-center gap-4 border-b pb-6">
        <div className="text-4xl bg-primary/10 p-4 rounded-lg">{/* We don't have lucide emoji so using raw */}'🕸️'</div>
        <div>
          <h1 className="text-4xl font-bold mb-2 text-foreground">الخرائط الذهنية</h1>
          <p className="text-lg text-muted-foreground">تمثيل بصري للمعلومات</p>
        </div>
      </div>
      ...
      <div className="pt-8 text-center">
        <Button size="lg" asChild>
          <Link href={`/session/new?technique=${encodeURIComponent('mind_mapping')}`}>
