  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-4 text-foreground font-tajawal">
      <div className="flex items-center gap-4 border-b pb-6">
        <div className="text-4xl bg-primary/10 p-4 rounded-lg">🕸️</div>
        <div>
          <h1 className="text-4xl font-bold mb-2 text-foreground font-cairo">الخرائط الذهنية</h1>
          <p className="text-lg text-muted-foreground font-tajawal">تمثيل بصري للمعلومات</p>
        </div>
      </div>
