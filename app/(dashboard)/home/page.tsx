    ...
    return (
        <div className="space-y-8 p-4">
            ...
            <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-6 rounded-lg border">
                <h1 className="text-3xl font-bold mb-2 text-foreground font-cairo">
                ...
                <div className="p-4 bg-background border rounded-md">
                    ...
                    <p className="text-sm text-muted-foreground text-center mt-2 font-tajawal">
                        طه: 25-26
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                <h2 className="text-2xl font-bold font-cairo">إجراءات سريعة</h2>
                <div className="flex gap-4">
                    <Button asChild>
                        <Link href="/techniques"><Plus className="ml-2 w-4 h-4" /> بدء جلسة جديدة</Link>
                    </Button>
                    <Button variant="outline" asChild>
                        <Link href="/workspaces"><Plus className="ml-2 w-4 h-4" /> إنشاء فريق</Link>
                    </Button>
                </div>
            </div>
            ...
            <div className="space-y-4 shadow-sm border p-4 rounded-lg bg-card">
                <h2 className="text-2xl font-bold text-card-foreground font-cairo">الجلسات الأخيرة</h2>
                <div className="divide-y divide-border">
                    {MOCK_SESSIONS.map((s) => (
                        <div key={s.id} className="py-4 flex items-center justify-between">
                            <div>
                                <p className="font-bold text-card-foreground font-tajawal">{s.title}</p>
                                <p className="text-sm text-muted-foreground font-tajawal">{s.technique} • {s.date}</p>
                            </div>
